...
let s:red = { "gui": "#e06c75", "cterm": "168", "cterm16": "1" } " Alternate cterm: 168
...
let s:blue = { "gui": "#61afef", "cterm": "75", "cterm16": "4" } " Alternate cterm: 75
let s:purple = { "gui": "#c678dd", "cterm": "176", "cterm16": "5" } " Alternate cterm: 176
let s:cyan = { "gui": "#56b6c2", "cterm": "73", "cterm16": "6" } " Alternate cterm: 73
let s:white = { "gui": "#dcdfe4", "cterm": "188", "cterm16" : "7" }
...
let s:gutter_fg_grey = { "gui": "#919baa", "cterm": "247", "cterm16": "15" }
